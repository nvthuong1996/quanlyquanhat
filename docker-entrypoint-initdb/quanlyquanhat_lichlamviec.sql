...
CREATE TABLE `lichlamviec` (
  ...
  `idlichdangky` int(11) NOT NULL,
  `gioden` varchar(45) DEFAULT NULL,
  `giodi` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `idlichlamviec_UNIQUE` (`idlichdangky`)
...
INSERT INTO `lichlamviec` VALUES (1,1,'13h19','13h19'),(2,4,NULL,NULL),(3,2,NULL,NULL),(4,3,NULL,NULL),(5,5,'14h6','14h10'),(6,11,'14h38','14h38');
...
-- Dump completed on 2019-12-01 20:15:42
